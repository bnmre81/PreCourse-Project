...
function afterX(numbers, x) {
  let i = numbers.indexOf(x) + 1;
  let res = numbers.slice(i, numbers.length);
  return res;
}
...
function abbreviate(firstName, lastName) {
  ...
  initialA = firstName[0].toUpperCase();
  initialB = lastName[0].toUpperCase();
